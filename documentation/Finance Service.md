...
El Servidor MCP delega todas las operaciones de base de datos a `expense_persistence.py`, que envuelve las llamadas SQLAlchemy contra la base de datos SQLite compartida (`data/travel_assistant.db`).
